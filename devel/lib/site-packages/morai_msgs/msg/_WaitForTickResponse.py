...
class WaitForTickResponse(genpy.Message):
  _md5sum = "c5462e58c40af45b551f16e432349406"
...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_i10d16f().pack(_x.vehicle_status.unique_id, _x.vehicle_status.acceleration.x, _x.vehicle_status.acceleration.y, _x.vehicle_status.acceleration.z, _x.vehicle_status.position.x, _x.vehicle_status.position.y, _x.vehicle_status.position.z, _x.vehicle_status.velocity.x, _x.vehicle_status.velocity.y, _x.vehicle_status.velocity.z, _x.vehicle_status.heading, _x.vehicle_status.accel, _x.vehicle_status.brake, _x.vehicle_status.wheel_angle, _x.vehicle_status.lateral_offset, _x.vehicle_status.tire_lateral_force_fl, _x.vehicle_status.tire_lateral_force_fr, _x.vehicle_status.tire_lateral_force_rl, _x.vehicle_status.tire_lateral_force_rr, _x.vehicle_status.side_slip_angle_fl, _x.vehicle_status.side_slip_angle_fr, _x.vehicle_status.side_slip_angle_rl, _x.vehicle_status.side_slip_angle_rr, _x.vehicle_status.tire_cornering_stiffness_fl, _x.vehicle_status.tire_cornering_stiffness_fr, _x.vehicle_status.tire_cornering_stiffness_rl, _x.vehicle_status.tire_cornering_stiffness_rr))
      _x = self.time
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.vehicle_status.unique_id, _x.vehicle_status.acceleration.x, _x.vehicle_status.acceleration.y, _x.vehicle_status.acceleration.z, _x.vehicle_status.position.x, _x.vehicle_status.position.y, _x.vehicle_status.position.z, _x.vehicle_status.velocity.x, _x.vehicle_status.velocity.y, _x.vehicle_status.velocity.z, _x.vehicle_status.heading, _x.vehicle_status.accel, _x.vehicle_status.brake, _x.vehicle_status.wheel_angle, _x.vehicle_status.lateral_offset, _x.vehicle_status.tire_lateral_force_fl, _x.vehicle_status.tire_lateral_force_fr, _x.vehicle_status.tire_lateral_force_rl, _x.vehicle_status.tire_lateral_force_rr, _x.vehicle_status.side_slip_angle_fl, _x.vehicle_status.side_slip_angle_fr, _x.vehicle_status.side_slip_angle_rl, _x.vehicle_status.side_slip_angle_rr, _x.vehicle_status.tire_cornering_stiffness_fl, _x.vehicle_status.tire_cornering_stiffness_fr, _x.vehicle_status.tire_cornering_stiffness_rl, _x.vehicle_status.tire_cornering_stiffness_rr,) = _get_struct_i10d16f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
